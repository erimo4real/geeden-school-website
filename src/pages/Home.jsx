      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">Why Choose {data.name}?</h2>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { quote: `The teachers at ${data.name} truly care about each student's success. My daughter has flourished here.`, author: "Maria Johnson", role: "Parent" },
