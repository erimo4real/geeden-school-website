...
export default function Admissions() {
  ...
  const [formData, setFormData] = useState(() => {
    const saved = localStorage.getItem('admissionsForm')
    return saved ? JSON.parse(saved) : {
      firstName: '', lastName: '', email: '', phone: '', grade: '', message: ''
    }
  })

  useEffect(() => {
    localStorage.setItem('admissionsForm', JSON.stringify(formData))
  }, [formData])
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem('admissionsSubmitted', JSON.stringify(cleanData))
